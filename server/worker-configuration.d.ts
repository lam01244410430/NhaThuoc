/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 20c70fadfe0897fd5dbb9cda13dc48ca)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
	PRODUCT_MEDIA: R2Bucket;
	nhathuoc_product_media: R2Bucket;
	DB: D1Database;
	JWT_SECRET: string;
	API_BASE_URL: string;
	FRONTEND_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "API_BASE_URL" | "FRONTEND_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FACEBOOK_APP_ID" | "FACEBOOK_APP_SECRET" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL" | "OTP_DEV_MODE">> {}
}
